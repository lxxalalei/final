---
name: ximalaya
description: 喜马拉雅资源站点。负责喜马拉雅音频搜索（专辑/声音），实现平台 Skill 标准搜索接口。下载能力规划中。集成站内 revision/search 公开 API。
---
...
脚本路径：`platforms/ximalaya/scripts/ximalaya_search.py`

```bash
# 搜索专辑（默认）
python3 platforms/ximalaya/scripts/ximalaya_search.py search \
