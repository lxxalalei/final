---
name: douyin
description: 抖音资源站点。负责抖音短视频搜索和下载，实现平台 Skill 标准接口。
---
...
# 搜索结果输出到 stdout
python3 platforms/douyin/scripts/douyin_dl.py search "趣味科普" --max 15

# 搜索失败时降级到 CDP 浏览器模式
python3 platforms/douyin/scripts/douyin_dl.py --cdp http://127.0.0.1:9222 search "英语启蒙" --max 20
```
