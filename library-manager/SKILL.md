...
description: 学习资料库管理 Skill。用于将 Stage 5 下载或降级结果去重、分类、移动并写入资料库索引，也用于检索、维护和统计已有资料。负责资料库状态，不负责搜索、筛选或下载。
---
...
此外支持按主题、年龄、类型、来源和标签检索现有资料，以及执行删除、统计和整理。
...
根据资源现有的主题、领域、适龄、类型和版本信息选择目录。证据不足时使用“待确认”，不要编造年级、教材版本或来源。
